...
public class Game {
   ...
   private int monster_x = mon.getLoc().getX();
   private int monster_y = mon.getLoc().getY();
   ...
   private void attackStart()
   {
	   if (!detectCollision())
		   return;
	   plyr.setHealth(plyr.getHealth() - mon.getAttack());
	   System.out.println("plyr health: " + plyr.getHealth());
	   if(plyr.getHealth()<=0)
		   System.exit(0);
	   mon.setHealth(mon.getHealth() - plyr.getAttack());
	   System.out.println("mon health: " + mon.getHealth());
